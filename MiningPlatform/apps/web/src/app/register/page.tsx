  ...
  return (
    <AuthCard title="Buat akun" description="Akun digunakan untuk mendaftarkan worker dan alamat payout.">
      <form className="space-y-4" aria-describedby="auth-status">
        ...
        <button type="button" disabled className="w-full cursor-not-allowed rounded-xl bg-[var(--accent)]/50 px-4 py-3 font-semibold text-[#04110c]/70">Registrasi belum aktif</button>
      </form>
      <p id="auth-status" className="mt-4 rounded-xl border border-amber-300/20 bg-amber-300/5 p-3 text-xs leading-6 text-amber-100">Form ini hanya pratinjau UI. Registrasi worker dan payout address belum diaktifkan.</p>

...
export const MiningEvents = {
  ...
  reconciliationExceptionOpened: 'reconciliation.exception.opened.v1',
  reconciliationExceptionSubmitted: 'reconciliation.exception.submitted.v1',
  reconciliationExceptionApproved: 'reconciliation.exception.approved.v1',
  reconciliationExceptionRejected: 'reconciliation.exception.rejected.v1',
  reconciliationExceptionResolved: 'reconciliation.exception.resolved.v1',

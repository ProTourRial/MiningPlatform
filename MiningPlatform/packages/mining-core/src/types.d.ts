 ...
 */
export type ShareState = 'RECEIVED' | 'VALIDATING' | 'LOCAL_ACCEPTED' | 'LOCAL_REJECTED' | 'UPSTREAM_PENDING' | 'UPSTREAM_ACCEPTED' | 'UPSTREAM_REJECTED' | 'UPSTREAM_TIMEOUT';
export type ShareRejectionCode = 'MALFORMED' | 'UNAUTHORIZED' | 'UNKNOWN_JOB' | 'STALE' | 'DUPLICATE' | 'LOW_DIFFICULTY' | 'INVALID_TIME' | 'INVALID_VERSION';

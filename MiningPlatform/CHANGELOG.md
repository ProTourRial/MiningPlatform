...
- Managed-source and release manifests verify at 717 and 718 files respectively; the dedicated alpha.8 static checker passes and requires version `0.3.0-alpha.8`, schema 23, the OAuth migration, the alpha.7 upgrade boundary, and the Codex assistance disclosure.

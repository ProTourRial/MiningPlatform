...
if (mode !== 'fresh' && mode !== 'upgrade') {
  throw new Error('Usage: node scripts/verify-alpha5-migration.mjs <fresh|upgrade>');
}
if (!process.env.DATABASE_URL) throw new Error('DATABASE_URL is required');
const expectedAck = mode === 'fresh' ? 'alpha5-fresh-empty-database' : 'alpha4-upgrade-copy';
...
process.stdout.write(`\nAlpha.5 ${mode} migration verification completed successfully.\n`);

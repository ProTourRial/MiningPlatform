...
if (mode !== 'fresh' && mode !== 'upgrade') throw new Error('Usage: node scripts/verify-v030-migration.mjs <fresh|upgrade>');
if (!process.env.DATABASE_URL) throw new Error('DATABASE_URL is required');
const expectedAck = mode === 'fresh' ? 'v030-fresh-empty-database' : 'alpha6-upgrade-copy';
...
process.stdout.write(`\nv0.3.0 ${mode} migration verification completed successfully.\n`);
